...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "hidden xl:flex w-[260px] flex-col gap-2 rounded-2xl border border-white/[0.07] bg-slate-900/60 p-4 shadow-2xl backdrop-blur-xl",
        className
      )}
    >
      {/* Logo */}
      <Link
        href="/"
        className="flex items-center gap-2.5 px-1 py-1 group mb-1"
        onClick={onNavigate}
      >
        ...
        <div>
          <p className="text-[10px] uppercase tracking-[0.2em] text-sky-400 font-bold leading-none mb-0.5">
            TaskFlow
          </p>
      ...
      <nav className="space-y-0.5 flex-1 overflow-y-auto scrollbar-none">
        ...
        <p className="px-2 mb-1.5 text-[10px] uppercase tracking-widest font-bold text-slate-600">
          Account
        </p>
        {accountLinks.map((item) => {
          ...
          return (
            <Link
              ...
              onClick={onNavigate}
              className={cn(
                "flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition duration-150 group border",
                isActive
      ...
      <div className="rounded-xl border border-white/[0.07] bg-slate-950/60 p-3 flex items-center gap-3 mt-1">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] text-slate-500 truncate">
            {reputationLevel(userProfile.reputation)} · {userProfile.reputation}{" "}
            pts
          </p>
        </div>
        <Link
