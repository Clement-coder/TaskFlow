        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-9 h-9 overflow-hidden rounded-xl bg-gradient-to-br from-sky-400 to-indigo-600 p-0.5 shadow-lg group-hover:scale-105 transition duration-300 flex items-center justify-center">
                <Image
