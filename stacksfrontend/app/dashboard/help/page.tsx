  ...
  return (
    <div className="space-y-7 pb-4">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Find answers, guides, and contact support</p>
      </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-2xl bg-slate-900/60 border border-white/[0.07] pl-12 pr-4 py-3.5 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-sky-500/60 focus:ring-2 focus:ring-sky-500/20 transition"
        />
      </div>
          ...
          {filteredFaqs.map((faq, i) => (
            <div key={i} className="rounded-2xl border border-white/[0.07] bg-slate-900/60 overflow-hidden hover:border-white/[0.12] transition duration-150">
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-white/[0.03] transition duration-150"
              >
