...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#020817] text-slate-100 flex">
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-[290px] bg-slate-900 border-r border-white/[0.07] p-5 transform transition-transform duration-300 ease-in-out xl:hidden flex flex-col ${
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Topbar */}
        <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-[#020817]/90 backdrop-blur-xl px-4 lg:px-8 h-[56px] flex items-center justify-between gap-4">
